...
var admin = "relacionesFamiliares";
...
var enviarPost = function (accion) {
    if ($("#frmRelacionFamiliar").valid()) {
        $("#frmRelacionFamiliar").attr("action", "/"+modulo+"/" + accion + admin + "Post/");
        var form = $('#frmRelacionFamiliar');
        $.ajax({
...
function iniciarModal() {
    ...
    validarFormulario("frmRelacionFamiliar", reglas, mensajes);
}

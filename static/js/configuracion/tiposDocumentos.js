...
var enviarPost = function (accion) {
    if ($("#frmTipodocumento").valid()) {
        $("#frmTipodocumento").attr("action", "/"+modulo+"/" + accion + admin + "Post/");
...
function iniciarModal() {
    ...
    var mensajes = {
        ...
        sigla: {
            required: 'Ingrese la sigla'
        },
        estregistro: {
            required: 'Seleccione estado del registro'
        }
    };
    validarFormulario("frmTipodocumento", reglas, mensajes);
}
